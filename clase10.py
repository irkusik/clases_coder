...
#print(devuelva_iterable(var2=2,var4=4,3,1,5))# va generar error siempre premiero mesclado viene organizado por posicion y despues por el nombre como en line ariba
#print(devuelva_iterable(var2=2,3,4,var1=1,5)) #va a generar error
#print(devuelva_iterable(1,2,4,var3=4)) # error
...
#ef devuelva_iterable(var1, var2, var3, var4, var5=5):
#    return var1, var2, var3, var4, var5
...
#print(devuelva_iterable(1,2,3,4,7)) #se domina valor que estoy pasando ariba de lo  que hay por defecto en funccion
#print(devuelva_iterable(1,2,3,4))
#print(devuelva_iterable(1,2,3)) # error var4 no esta porque no tiene valor por defecto
#print(devuelva_iterable(1,2)) #error
# print(devuelva_iterable(1)) #error
