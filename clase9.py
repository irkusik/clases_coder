...
# ====================================================================
# ====================================================================
# def se usa para defenir la funccion
...
#suma_de_valores = sumar_numeros()
#print(suma_de_valores)def sumar_numeros():
...
#suma_de_valores = sumar_numeros()
#valor1 = 4
#print(suma_de_valores) # aca va a generar un error
...
#valor1 = 4
#suma_de_valores = sumar_numeros()
#print(valor2) #esta dentro de la funccion desde afuera no puedo ver que esta adentro de la funccion
#print(suma_de_valores)
...
#def anio_bisiestro(anio):
#    if anio % 4 == 0 and (anio % 100 != 0 or anio %400 == 0) :
#        return ('El año es bisiesto')
#    else:
#        return ('El año no es bisiesto')
#print(anio_bisiestro(2021))
...
while True:
    ...
    anio =int(input ('Ingresa un número:'))  
    print(anio_bisiestro(anio))
