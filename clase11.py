# Errores de sintaxis por errores de codigo
...
# Errores semanticos (codigo esta bien escrito pero resultado no tiene sentido )
...
#print(dividir(5,0))
#print(dividir('5',0))
#print(dividir('5',5)) # no sepuede dividir str por numero
